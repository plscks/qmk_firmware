...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,    KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, KC_MUTE,    KC_MPLY, KC_N,    KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                KC_CAPS, KC_ENCMOD, KC_LALT, KC_LOWER, KC_SPC,    KC_ENT, KC_BSPC, KC_RAISE, KC_RGUI, KC_RCTL
    ),
    /*
    * COLEMAKDH
    * ,-----------------------------------------.                    ,-----------------------------------------.
    ...
    */
    ...
    KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,     KC_MPLY,KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                KC_CAPS, KC_ENCMOD, KC_LALT, KC_LOWER, KC_SPC,      KC_ENT, KC_BSPC, KC_RAISE, KC_RGUI, KC_RCTL
    ),
    /*
     * WORK
    * ,-----------------------------------------.                    ,-----------------------------------------.
    ...
    [_ADJUST] = LAYOUT(XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        QK_BOOTLOADER, KC_COLEMAKDH, KC_QWERTY, KC_WORK, CG_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
